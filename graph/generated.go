...
func (ec *executionContext) field_Mutation_upsertCharacter_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNCharacterInput2githubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacterInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_upsertCharacter(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Mutation_upsertCharacter,
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Mutation().UpsertCharacter(ctx, fc.Args["input"].(model.CharacterInput))
		},
		nil,
		ec.marshalNCharacter2ᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacter,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_character(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOCharacter2ᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacter,
		true,
		false,
	)
}
...
func (ec *executionContext) _Query_kooks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Query_kooks,
		func(ctx context.Context) (any, error) {
			return ec.resolvers.Query().Kooks(ctx)
		},
		nil,
		ec.marshalNCharacter2ᚕᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacterᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_pogues(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Query_pogues,
		func(ctx context.Context) (any, error) {
			return ec.resolvers.Query().Pogues(ctx)
		},
		nil,
		ec.marshalNCharacter2ᚕᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacterᚄ,
		true,
...
func (ec *executionContext) fieldContext_Query_pogues(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
...
func (ec *executionContext) marshalNCharacter2githubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v model.Character) graphql.Marshaler {
	return ec._Character(ctx, sel, &v)
}

func (ec *executionContext) marshalNCharacter2ᚕᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacterᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Character) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNCharacter2ᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacter(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNCharacter2ᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOCharacter2ᚖgithubᚗcomᚋaecsarᚋgoᚑgraphqlᚋgraphᚋmodelᚐCharacter(ctx context.Context, sel ast.SelectionSet, v *model.Character) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Character(ctx, sel, v)
